...
public class AudioManager : MonoBehaviour
{
    ...
    void Update()
    {
        // Met � jour automatiquement la position de tous les events 3D
        foreach (var kvp in tracked3DEvents)
        {
            ...
            {
                // Lib�re les instances invalides ou dont le GameObject a �t� d�truit
            ...
            {
                // Met � jour la position et la v�locit�
